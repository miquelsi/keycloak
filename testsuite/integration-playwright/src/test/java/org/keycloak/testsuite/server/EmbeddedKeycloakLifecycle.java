 ...
 */
public final class EmbeddedKeycloakLifecycle implements KeycloakLifecycle {
    ...
    private static EmbeddedKeycloakLifecycle instance;

    private static boolean isRunning = false;

    private EmbeddedKeycloakLifecycle() {
    }

    public static EmbeddedKeycloakLifecycle getInstance() {
        if (instance == null) {
            instance = new EmbeddedKeycloakLifecycle();
        }
        return instance;
    }
